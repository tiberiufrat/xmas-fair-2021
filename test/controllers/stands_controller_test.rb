...
class StandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stand" do
    assert_difference('Stand.count') do
      post stands_url, params: { stand: { name: @stand.name, operator_id: @stand.operator_id } }
    end
  ...
  test "should update stand" do
    patch stand_url(@stand), params: { stand: { name: @stand.name, operator_id: @stand.operator_id } }
